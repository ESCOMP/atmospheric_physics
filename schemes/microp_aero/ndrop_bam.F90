...
contains
  ...
  subroutine ndrop_bam_init(amIRoot, iulog, mwh2o, r_universal, tmelt, rhoh2o, &
    ...
    ! Find BAM properties object from factory. The list index selects the radiation
    ! list to query; 0 is the climate list (1..N_DIAG are the diagnostic lists).
    aero_props_bam => null()
    ...
    ! Each BAM bin holds exactly one species, hence species_ndx is always 1.
    do iaer = 1, naer_all
      call aero_props_bam%get(bin_ndx=iaer, species_ndx=1, &
...
!===============================================================================
  ...
  subroutine activate( &
    ...
    ! growth coefficent Abdul-Razzak & Ghan 1998 eqn 16, https://doi.org/10.1029/97JD03735
...
!===============================================================================
  ...
  pure subroutine maxsat(zeta, eta, nmode, smc, smax)
