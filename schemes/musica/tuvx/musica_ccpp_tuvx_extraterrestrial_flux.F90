...
contains
  ...
  function create_extraterrestrial_flux_profile(wavelength_grid, &
    ...
    ! local variables
    type(error_t) :: error
    real(kind_phys) :: wavelength_grid_interfaces_(size( wavelength_grid_interfaces )) ! nm
  ...
  subroutine set_extraterrestrial_flux_values(profile, data_num_wavelength_grid_bins, &
    ...
    real(kind_phys) :: wavelength_grid_interfaces_(8) = [4.0, 5.0, 6.0, 7.0, 4.0, 5.0, 6.0, 7.0]
