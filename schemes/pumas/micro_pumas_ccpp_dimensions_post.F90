...
contains
  ...
  subroutine micro_pumas_ccpp_dimensions_post_run(ncol, micro_ncol, nlev, micro_nlev,                   &
    ...
    lflx(:,:micro_nlev1)                 = pumas_lflx(:ncol,:)
    iflx(:,:micro_nlevl)                 = pumas_iflx(:ncol,:)
    gflx(:,:micro_nlevl)                 = pumas_gflx(:ncol,:)
    rflx(:,:micro_nlevl)                 = pumas_rflx(:ncol,:)
    sflx(:,:micro_nlevl)                 = pumas_sflx(:ncol,:)
