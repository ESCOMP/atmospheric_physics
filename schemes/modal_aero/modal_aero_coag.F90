...
!!$             t(i,k), pmid(i,k)*1.0e-2_kind_phys, aircon, pdel(i,k)*1.0e-2_kind_phys
!!$         write(lunout,9820) 'wetdens-cgs, sg      f/t',   &
!!$             wetdens_frm*1.0e-3_kind_phys, wetdens_too*1.0e-3_kind_phys,   &
!!$             sg_frm, sg_too
!!$         write(lunout,9820) 'dgnwet-um, dgndry-um f/t',   &
!!$             1.0e6_kind_phys*wetdgnum_frm, 1.0e6_kind_phys*wetdgnum_too,   &
!!$             1.0e6_kind_phys*dgncur_a(i,k,modefrm), 1.0e6_kind_phys*dgncur_a(i,k,modetoo)
